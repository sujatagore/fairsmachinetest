...
@Component({
    ...
    templateUrl : './fairsdash.component.html',
    styleUrls : ['./fairsdash.component.scss']
})

export class FairDashboard implements OnInit{
  ...
  ngOnInit(): void {
    this.selected = this.fairsArr[0]
  }

  selectedFair(fair : IFair){
    this.selected = fair
  }
}